...
`include "../integration_tests/buy_for_dollars_after_change_exchange_rate_test.sv"
`include "../integration_tests/buy_for_euros_after_change_exchange_rate_test.sv"
